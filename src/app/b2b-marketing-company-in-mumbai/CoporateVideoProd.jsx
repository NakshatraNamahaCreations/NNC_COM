...
export default function B2BMarketingCompanyMumbai() {
    ...
    "@graph": [
      {
        ...
        "url": "https://www.nakshatranamahacreations.com/b2b-marketing-company-in-mumbai",
      ...
      },
      {
        "@type": "WebPage",
        "@id":
          "https://www.nakshatranamahacreations.com/b2b-marketing-company-in-mumbai#webpage",
        "url":
          "https://www.nakshatranamahacreations.com/b2b-marketing-company-in-mumbai",
        "name":
          "B2B Marketing Company in Mumbai | Lead Generation & Demand Growth",
        "description":
          "Trusted B2B marketing company in Mumbai helping businesses generate qualified leads, build strong sales pipelines, and drive revenue growth through structured B2B marketing strategies."
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name":
              "What services does a B2B marketing company in Mumbai offer?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text":
                "A B2B marketing company in Mumbai offers services such as B2B lead generation, account-based marketing, LinkedIn advertising, SEO, content marketing, demand generation, and performance marketing."
            }
          },
          {
            "@type": "Question",
