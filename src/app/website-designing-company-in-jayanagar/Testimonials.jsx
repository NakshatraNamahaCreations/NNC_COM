...
const clientReviews = [
  {
    ...
    text:"They understood exactly what we needed and created a beautiful, functional site—proof we chose the right Website Designing Company in Jayanagar",
...

  {
    ...
    company: "TVS Sundaram Motors",
    text:
     "Our business website now loads faster and looks fantastic on every device. Truly the most reliable Website Designing Company in Jayanagar.",
    img: "/media/gif/woman (1).png",
  },
