        ...
        <div className={styles.container1}>
          ...
          <div className={styles.left1}>
            ...
            <p className={styles.description}>
              Partnering with a professional graphic design company in Mumbai
            ...
            <p className={styles.description}>
              ...
              clarity and design precision. Our graphic design process ensures
              consistency, visual balance, and alignment with your brand goals.
            </p>
          </div>
