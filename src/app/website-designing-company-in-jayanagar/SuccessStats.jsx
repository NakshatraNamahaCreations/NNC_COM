...
const pillarsData = [
    ...
    title: "Helps to Build Trust",
    description:
      "A Website Designing Company in Jayanagar will assist you in appearing to be a professional and trustworthy company from the very first interaction online.",
  },
  {
    icon: <FaClock size={32} />,
    title: "Presence Online 24/7",
    description:
      "Your website is like a salesperson who never rests and is always available to help or sell to the customer. This is another reason for which you should go for a Website Designing Company in Jayanagar.",
  },
  {
    icon: <FaMapMarkerAlt size={32} />,
    title: "Get More Local Customers",
    description:
      "Appear in local results with a site that was created by a Website Designing Company in Jayanagar which is aware of the neighbor.",
  },
  {
    icon: <FaPaintBrush size={32} />,
    title: "Refining the User Interface and Experience",
    description:
      "Confidently showcase your services or products with the help of eye-catching images, descriptive texts, and call-to-action buttons, all of which have been created by a Website Designing Company in Jayanagar with an aim to drive conversions.",
  },
  {
    icon: <FaComments size={32} />,
    title: "Enhances Customer Interaction",
    description:
      "Forms, chat, and bookings—created by a Website Designing Company in Jayanagar—are the ways in which customers can quickly and easily communicate with you.",
  },
  {
    icon: <FaBullhorn size={32} />,
    title: "Facilitates Digital Marketing",
    description:
      "SEO, Ads, and social will all perform better if you have a site from a Website Designing Company in Jayanagar that is compatible with your funnel.",
  },
];
...
<div className={styles.corePillarWrapper1}>
  <h2 className={styles.corePillarHeading}>
   Why Every Business in Jayanagar, Bangalore Needs a Website
  </h2>
