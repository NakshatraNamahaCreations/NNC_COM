    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <h2 className={styles.heading}>
          Industries We Serve
          <span> as Social Media Marketing In Mumbai</span>
        </h2>

        <p className={styles.subText}>
          As a professional Social Media Marketing In Mumbai, we deliver
          industry-focused marketing solutions that help businesses communicate
          effectively, strengthen brand credibility, and engage their target
          audience. Every campaign is created to match the unique communication
