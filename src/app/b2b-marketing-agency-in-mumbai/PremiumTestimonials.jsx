...
const reviews = [
  {
    name: "Rahul Mehta",
    company: "Mehta Software Solutions",
    googleLogo: "/media/icons/google.png",
    rating: 5,
    text: "Nakshatra Namaha Creations is a highly reliable B2B marketing agency in Mumbai. Their lead generation and LinkedIn marketing strategies helped us connect with the right decision-makers and significantly improve our sales pipeline.",
  },
  {
    name: "Priyanka Shah",
    company: "Shah Consulting Group",
    googleLogo: "/media/icons/google.png",
    rating: 5,
    text: "We partnered with Nakshatra Namaha Creations as our B2B marketing agency in Mumbai, and the results were excellent. Their structured approach to demand generation and reporting gave us clear visibility into campaign performance.",
  },
  {
    name: "Sandeep Rao",
    company: "Rao Industrial Systems",
    googleLogo: "/media/icons/google.png",
    rating: 5,
  ...
  },
  {
    ...
    company: "Fernandes Healthcare Solutions",
    googleLogo: "/media/icons/google.png",
    rating: 5,
  ...
  {
    name: "Vikas Malhotra",
    company: "Malhotra Fintech Services",
    googleLogo: "/media/icons/google.png",
    rating: 5,
    text: "Choosing Nakshatra Namaha Creations as our B2B marketing agency in Mumbai was a smart decision. Their account-based marketing and LinkedIn Ads helped us reach senior-level prospects efficiently.",
  },
  {
    name: "Ritu Nandakumar",
    company: "Nandakumar EdTech Pvt Ltd",
    googleLogo: "/media/icons/google.png",
    rating: 5,
