    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <h2 className={styles.heading}>
          Industries We Serve
          <span> as a B2B Marketing Agency in Mumbai</span>
        </h2>

        <p className={styles.subText}>
          As a trusted <strong>B2B marketing agency in Mumbai</strong>, we help
          businesses across diverse industries generate qualified leads, build
          strong sales pipelines, and achieve consistent growth through
