...
const pillarsData = [
   {
    ...
    description:
      "We at least believe every business to be struggling with the need for a unique website. Our Website Development Company in Rajajinagar makes designs not only transparent of your brand identity but also of your aim, thus letting you be different from the competitors.",
  },
  {
    icon: <FaUserFriends size={32} />,
    title: "Focus on User Experience (UX)",
    description:
      "Our squad is totally immersed in navigation and usability. Being the best Website Development Company in Rajajinagar, we turn to the creation of intuitiveness, speed, and appeal to keep users thrilled and conversions growing.",
  },
  {
    icon: <FaSearch size={32} />,
    title: "SEO-Ready from Day One",
    description:
      "Our Website Development Company in Rajajinagar performs the integration of SEO strategies during the developmental stage to be able to rank higher and get more local customers in Bangalore.",
  },
  {
    icon: <FaComments size={32} />,
    title: "Transparent Communication",
    description:
      "We are very much into clarity and collaboration. Working with our Website Development Company in Rajajinagar means keeping away from the traps of hidden costs and surprises — only the consistency of the progress updates.",
  },
  {
    icon: <FaGlobe size={32} />,
    title: "Local Expertise, Global Standards",
    description:
      "We being situated in Rajajinagar not only helps us to get your target market but also enables us to implement the global design and development standards that assure success.",
  },
  {
    icon: <FaWrench size={32} />,
    title: "Ongoing Support & Maintenance",
    description:
      "Our Website Development Company in Rajajinagar is always ready with hand and heart to render continuous maintenance, updates, and optimization even after the launch — thus your site will always be at its peak.",
  },
];
...
<div className={styles.corePillarWrapper1}>
  <h2 className={styles.corePillarHeading}>
   What Sets Nakshatra Namaha Creations Apart in Rajajinagar?
  </h2>
 <p style={{fontSize:"18px", width:"70%", margin:"0 auto", paddingBottom:"40px"}}>Nakshatra Namaha Creations is not merely another Website Development Company in Rajajinagar — we are your digital growth partners. Here is why local businesses are willing to put their trust in us:</p>
