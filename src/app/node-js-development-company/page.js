...
export const metadata = {
  ...
  keywords:
    "Node JS development company , Hire Node JS developers , Node.js backend development , Custom, Node JS services , Node JS API development  ",
  alternates: {
    canonical:
      "https://www.nakshatranamahacreations.com/node-js-development-company",
  },
  openGraph: {
    title: "Top Node JS Development Company",
    description:
