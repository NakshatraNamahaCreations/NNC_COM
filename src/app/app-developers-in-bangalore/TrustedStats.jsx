    ...
    <section className={styles.wrapper}>
      <div className={styles.inner}>
        ...
        <div className={styles.stats}>
          <Counter end={60} suffix="M+" label="Funds Raised for Clients" />
          <span className={styles.divider}></span>
          <Counter end={50} suffix="+" label="Successful Projects Delivered" delay={200} />
          <span className={styles.divider}></span>
          <Counter end={70} suffix="+" label="Professionals in Our Team" delay={400} />
        </div>
