...
const ITEMS = [
  {
    quote:
      "Nakshatra Namaha Creations helped us launch our mobile app in record time. The Flutter App Development Company delivered more than expected — both in design and performance",
    name: "Ankit M",
  ...
  {
    quote:
      "Their Flutter App Development Company optimized our logistics operations. We went live on Android and iOS simultaneously, saving significant costs",
    name: "Priya R",
    ...
    {
    quote:
      "The team’s ability to translate our vision into a responsive interface truly impressed us. Our Flutter app works flawlessly!",
    name: "Sameer P",
  ...
  {
    quote:
      "Professional, proactive, and reliable — Nakshatra Namaha Creations proved why they’re among the best in Flutter App Development Company",
    name: "Divya S",
