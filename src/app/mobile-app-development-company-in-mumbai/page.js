...
export const metadata = {
  ...
  alternates: {
    canonical:
      "https://www.nakshatranamahacreations.com/mobile-app-development-company-in-mumbai",
  },
  openGraph: {
    title: "Mobile App Development Company – Android & iOS App Services",
    description:
    ...
    url: "https://www.nakshatranamahacreations.com/mobile-app-development-company-in-mumbai",
    images: [
      {
