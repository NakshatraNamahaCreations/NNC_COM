    ...
    <section className={styles.processSection}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p>
           Choosing the right custom crm development company plays a major role in long-term CRM success. Our approach focuses on practical implementation, clear workflows, and measurable business improvements.
           </p>
        </div>
        ...
        <div className={styles.layout}>
          ...
          <div className={styles.right}>
            <Step number="01" title="Business-Focused CRM Development">
              Every custom CRM development project is built around your sales workflow, customer journey, and operational requirements.
            </Step>

            <Step number="02" title="Automation That Saves Time">
              We reduce repetitive manual tasks through structured automation and workflow optimization.
            </Step>
            ...
            <Step number="04" title="Reliable CRM Integration">
              We ensure seamless integration with existing business tools and platforms.
            </Step>

            <Step number="05" title="Transparent Development Process">
