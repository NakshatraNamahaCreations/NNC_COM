...
const ITEMS = [
  {
    quote:
      "The Graphic Designing Company elevated our brand campaign with creativity and precision. Everything was delivered on time.",
    name: "Anil R",
  ...
  {
    quote:
      "Our packaging and logo were beautifully done. This Graphic Designing Company truly understood our needs",
    name: "Sneha M",
    ...
    {
    quote:
      "The mockups were clean, modern, and professional. The Graphic Designing Company team nailed our UI requirements",
    name: "Ravi T",
  ...
  {
    quote:
      "From brochures to pitch decks, the Graphic Designing Company handled every project flawlessly.",
    name: "Lavanya D",
