...
const pillarsData = [
   {
    ...
    description:
      "A long time of providing top-quality solutions specially made for your business.",
  },
  {
    icon: <FaCogs size={32} />,
    title: "Customized Solutions",
    description:
      "The designs and features that are in harmony with your brand and objectives.",
  },
  {
    icon: <FaLaptopCode size={32} />,
    title: "Advanced Technologies",
    description:
      "WordPress, React, Node (and more) for future-ready projects.",
  },
  {
    icon: <FaSearch size={32} />,
    title: "SEO-Optimized Websites",
    description:
      "Clean IA, schema-ready, and on-page best practices.",
  },
  {
    icon: <FaMobileAlt size={32} />,
    title: "Mobile-First Approach",
    description:
      "Perfect user experiences on all devices and breakpoints.",
  },
  {
    icon: <FaShoppingCart size={32} />,
    title: "E-Commerce Excellence",
    description:
      "Stores that are safe, full of features, and easy for payments.",
  },
  {
    icon: <FaHeadset size={32} />,
    title: "Reliable Support",
    description:
      "Periodic maintenance, updates, and performance checks.",
  },
  {
    icon: <FaClock size={32} />,
    title: "Timely Delivery",
    description:
      "Open milestones and launches that are done on time—every time.",
  },
];
...
<div className={styles.corePillarWrapper1}>
  ...
  Why Choose Nakshatra Namaha Creations for a Web Design Company in JP Nagar, Bangalore?
  </h2>
