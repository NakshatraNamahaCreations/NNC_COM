...
const ITEMS = [
  {
    quote:
      "Our app launch received overwhelming response thanks to their Motion Graphics Services. The explainer video made our product incredibly easy to understand, and user sign-ups increased instantly",
    name: "Karthik R",
    role: "Product Marketing Manager at VeloTech",
    avatar: "/media/icons/man (6).png",
  },
  {
    quote:
      "Their team transformed our script into stunning visuals through their Motion Graphics Services. Every frame felt purposeful, and the communication throughout the project was smooth and professional",
    name: " Priya M",
     role: "Co-Founder at CloudSphere",
    avatar: "/media/icons/woman (5).png",
  },
  {
     quote:
      "We opted for their Motion Graphics Services for a social media push, and the kinetic typography video quickly went viral on Instagram and YouTube. The creativity exceeded our expectations",
    name: "Arjun S",
    role: "Brand Head at Nexa Retail",
    avatar: "/media/icons/man (6).png",
  },
  {
    quote:
      "They delivered top-notch Motion Graphics Services right on schedule. The final output aligned perfectly with our brand style, and collaborating with them was genuinely enjoyable",
    name: "Neha T",
    role: "Training & Development Lead at EduBridge",
    avatar: "/media/icons/woman (5).png",
  }
