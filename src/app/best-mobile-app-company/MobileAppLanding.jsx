...
// //         position: "relative",
// //         minHeight: "100vh",
// //         backgroundImage: "url('/mbbanner.png')",
...
// //             <h1 style={{ fontSize: "3rem", fontWeight: "bold", lineHeight: "1.3" }}>
// //               Best Mobile App <br /> Development Company <br /> in Bangalore
// //             </h1>
// //             <p style={{ fontSize: "1.1rem", marginTop: "1rem" }}>
// //               We build high-quality, scalable, and user-friendly mobile
...
// //           <Col
// //             md={6}
// //             className="d-flex justify-content-center mt-5 mt-md-0 position-relative"
// //           >
         

// //             {/* Client Reviews Bubble */}
// //             <div
// //               style={{
// //                 position: "absolute",
// //                 top: "10%",
...
//                 <h2 style={{ color: "#ff6200", fontSize: "2rem" }}>
//                   Why Choose Nakshatra Namaha Creations?
//                 </h2>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   Delivering Innovation with Every App
//                 </p>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   At Nakshatra Namaha Creations, we specialize in creating mobile applications that blend cutting-edge technology with user-centric design, ensuring your app stands out in the competitive marketplace.
//                 </p>
//               </div>
//             </Col>
//           </Row>
//           <Row className="mt-4">
//             <Col md={4}>
//               <div style={{ background: "#fff", padding: "20px", borderRadius: "10px", textAlign: "center", boxShadow: "0 4px 6px rgba(0,0,0,0.1)" }}>
//                 <div style={{ background: "#ff6200", borderRadius: "50%", width: "50px", height: "50px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center" }}>
//                   <span style={{ color: "#fff", fontSize: "1.5rem" }}>🚀</span>
//                 </div>
//                 <h3 style={{ marginTop: "10px", fontSize: "1.2rem" }}>Expert Mobile App Development</h3>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   Our experienced team of developers brings years of expertise in developing intuitive, responsive, and high-performance mobile apps. Whether it's Android, iOS, or cross-platform development, we ensure your app functions seamlessly across devices.
//                 </p>
//               </div>
//             </Col>
//             <Col md={4}>
...
//                   <span style={{ color: "#fff", fontSize: "1.5rem" }}>🎨</span>
//                 </div>
//                 <h3 style={{ marginTop: "10px", fontSize: "1.2rem" }}>Tailored Solutions to Meet Your Needs</h3>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   We understand that every business is unique. That's why we offer customized app development solutions that are perfectly aligned with your business objectives, helping you reach your target audience efficiently.
//                 </p>
//               </div>
//             </Col>
//             <Col md={4}>
...
//                 </div>
//                 <h3 style={{ marginTop: "10px", fontSize: "1.2rem" }}>Fast & Reliable Delivery</h3>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   We deliver high-quality mobile applications within the agreed timelines, ensuring that your project is launched on time and on budget. Our streamlined process guarantees speed without compromising on quality.
//                 </p>
//               </div>
//             </Col>
//           </Row>
...
//                   <span style={{ color: "#fff", fontSize: "1.5rem" }}>🔧</span>
//                 </div>
//                 <h3 style={{ marginTop: "10px", fontSize: "1.2rem" }}>End-to-End Services</h3>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   From ideation and design to development, testing, and deployment, we offer comprehensive mobile app development services. We don’t just build apps; we create long-lasting digital experiences.
//                 </p>
//               </div>
//             </Col>
//             <Col md={6}>
...
//                   <span style={{ color: "#fff", fontSize: "1.5rem" }}>🛠️</span>
//                 </div>
//                 <h3 style={{ marginTop: "10px", fontSize: "1.2rem" }}>Ongoing Support & Maintenance</h3>
//                 <p style={{ color: "#666", fontSize: "0.9rem" }}>
//                   Our commitment doesn't end with the launch. We provide continuous support and maintenance to ensure your app remains up-to-date, secure, and performs optimally throughout its lifecycle.
//                 </p>
//               </div>
//             </Col>
//           </Row>
...
//               <Button variant="outline-primary" style={{ borderRadius: "20px", padding: "10px 20px" }}>
//                 Activate
//               </Button>
//               <Button variant="primary" style={{ borderRadius: "20px", padding: "10px 20px", marginLeft: "10px" }}>
//                 Go to See
//               </Button>
//             </Col>
//           </Row>
...
>
  ...
  {/* Content */}
  <div
    className="text-light w-75 px-4"
    style={{ position: "relative", zIndex: 2 }} // keep content above overlay
  >
    <Row className="justify-content-start">
      {/* Left Text */}
      <Col lg={7} md={12} className="text-start mt-5 pt-3">
      ...
      {/* Right Form */}
  <Col
  lg={{ span: 4, offset: 8 }}   // pushes the column to the right side
  md={12}
  className="mt-24"
>
  <Card className="shadow-lg p-4 bg-white" style={{ zIndex: 2 }}>
    <h4 className="fw-bold mb-3 text-center text-dark">Get in Touch</h4>
