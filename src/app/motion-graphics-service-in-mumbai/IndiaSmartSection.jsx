        ...
        <div className={styles.left}>
          <div className={styles.stickyImage}>
            <img
              ...
              alt="Motion Graphic Service In Mumbai – Design Process Overview"
        ...
        <div className={styles.right}>
          ...
          <div className={styles.header}>
            <h2 className={styles.heading}>
              Our Process as{" "}
              <span>Motion Graphic Service In Mumbai</span>
            </h2>

            <p className={styles.subText}>
              As a professional Motion Graphic Service In Mumbai, we follow a
