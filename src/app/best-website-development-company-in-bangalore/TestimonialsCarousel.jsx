...
const ITEMS = [
  {
    quote:
      "They understood our business requirements clearly and delivered a professional, fast, and user-friendly website that perfectly supports our digital goals.",
    name: "Ravi Kumar",
    role: "Chief Technology Officer, UGRO Capital Ltd",
    avatar: "/media/icons/man (6).png",
  },
  {
    quote:
      "The team was easy to work with and maintained excellent communication throughout the project. The website was delivered on time with great attention to detail.",
    name: "Meenakshi Rao",
    role: "Chief Accounts & Finance Officer, Astute Group",
    avatar: "/media/icons/woman (5).png",
  },
  {
    quote:
      "Their structured website development process and focus on usability helped us create a platform that works smoothly across all devices.",
    name: "Abhinav Joshi",
  ...
  {
    quote:
      "The new website significantly improved our online presence. The design, performance, and overall experience reflect a truly professional development team.",
    name: "Smita Rajan",
