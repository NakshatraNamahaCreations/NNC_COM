 ...
 const track = [...ITEMS, ...ITEMS];
  ...
  />
          ...
          {/* Right image */}
            ...
            <h2 className={styles.title}>Industries We Serve as a Leading Website Development Company in RR Nagar, Bangalore</h2>
            <p className={styles.lead} style={{fontSize:"18px"}}>
          Ranking #1 among the best Website Development Companies in RR Nagar, Nakshatra Namaha Creations is an adept firm that provides along with- Website Development, Digital Marketing, and Branding Services to various industries like Retail, Healthcare, Education, Real estate, Hospitality, and Startups, across Bangalore. Our intent behind the Website Designing is to increase the customer base of the company, by giving visual prominence to the company’s products and services. Our Website Development Company in RR Nagar is at your service providing you with tailor-made digital solutions irrespective of your sector that will make your business climb to the next level.
            </p>
