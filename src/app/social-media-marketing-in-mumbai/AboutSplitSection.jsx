    ...
    <>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.left}>
            <h2 className={styles.heading}>
              Social Media Marketing <span>In Mumbai for Business Growth</span>
            </h2>

            <p className={styles.description}>
              A strong visual identity plays a major role in how customers
              perceive your brand. As a professional Social Media Marketing In
            ...
            <p className={styles.description}>
              ...
              graphics, brochures, and digital assets, our Social Media Marketing
      ...
      >
        ...
        <div className={styles.content}>
          ...
          <p>
            Partner with a trusted Social Media Marketing In Mumbai to create
