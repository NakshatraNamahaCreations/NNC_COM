        ...
        <div className={styles.grid}>
          ...
          <div className={styles.content}>
            <span className={styles.badge}>
              ...
              Concept • Animate • Deliver Engaging Videos
            </span>

            <h1 className={styles.heading}>
              Animated Video Creators <br />
              <span>In Mumbai</span>
            </h1>

            <p className={styles.subText}>
              We create engaging animated videos in Mumbai that help businesses
              explain ideas clearly, promote products effectively, and connect
              with their audience through visual storytelling.
            </p>
