...
const ITEMS = [
  {
    quote:
      "Working with Nakshatra Namaha Creations was a smooth and professional experience. They built our website exactly how we envisioned it—fast, clean, and scalable",
    name: "Ravi S",
  ...
  {
    quote:
      "Their team didn’t just develop our platform, they added value with smart suggestions and great communication. Highly recommended for React projects!",
    name: "Priya K",
    ...
    {
    quote:
      "We migrated our old front-end to React with their help, and the results were fantastic. Our site is now faster, easier to maintain, and looks amazing on all devices.",
    name: "Arjun M",
  ...
  {
    quote:
      "Nakshatra Namaha Creations brought our vision to life with a stunning React-based website. Their attention to detail, design sense, and technical skill made the whole process seamless. We loved working with them!",
    name: "Sneha R",
